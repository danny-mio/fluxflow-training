...
We take security vulnerabilities seriously. If you discover a security issue in FluxFlow Training, please report it responsibly.
...
1. **GitHub Security Advisories** (Preferred)
   - Go to https://github.com/danny-mio/fluxflow-training/security/advisories
   - Click "Report a vulnerability"
   - Provide detailed information about the vulnerability

2. **Email**
   - Send to: danny-mio@libero.it
   - Subject: "[SECURITY] FluxFlow Training - [Brief Description]"
...
- **General questions**: https://github.com/danny-mio/fluxflow-training/discussions
- **Bug reports**: https://github.com/danny-mio/fluxflow-training/issues
